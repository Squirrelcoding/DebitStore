...
app.get('/create', function(req, res) {
    ...
    res.render('make', {
        code: code + " Is your code, do not forget it! This is the code that will let YOU have access to YOUR cards!"
    });
    var f = {
        object: {
            0: ""
...
app.post('/deleteForm', (req, res) => {
    ...
    deleteCard();
    res.writeHead(301, {
        Location: 'https://www.debitstore.tk'
    });
    res.end("");
})
